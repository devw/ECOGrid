...
DEMOGRAPHIC_TABLE_CAPTION = (
    ...
    "NI = No Incentive (baseline, no intervention); "
    "SI = Service Incentive (token-based rewards redeemable for municipal services); "
    "EI = Economic Incentive (direct monetary subsidies).\n"
    "**PRIM-identified optimal segments:** "
    "NI segment = Baseline Population (no demographic restrictions); "
    "SI segment = High Trust Community (Trust ≥ 0.65); "
    "EI segment = High Trust + Mid-High Income (Trust ≥ 0.55, Income ≥ 30k).\n"
...
AGGREGATE_TABLE_CAPTION = (
    ...
    "**Policy scenarios:** "
    "NI = No Incentive (baseline); "
    "SI = Service Incentive (token-based municipal services); "
    "EI = Economic Incentive (monetary subsidies). "
