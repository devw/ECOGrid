...
```bash
python -m src.analysis.csv_validation_analysis -d data/montecarlo_calibrated_fixed 
```
...
python -m src.scripts.presentation.generate_demographic_table --data-dir data/montecarlo_calibrated_fixed --output-dir /tmp/
```
